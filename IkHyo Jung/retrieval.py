...
class SparseRetrieval:
    def __init__(self, tokenize_fn, data_path="./data/", context_path="wikipedia_documents.json"):
        ...
        # Transform by vectorizerfrom datasets import load_from_disk
...
if __name__ == "__main__":
    data_set = load_from_disk("/opt/ml/input/data/data/train_dataset")
    full_ds = concatenate_datasets(
        [
            data_set["train"].flatten_indices(),
            data_set["validation"].flatten_indices(),
        ]
